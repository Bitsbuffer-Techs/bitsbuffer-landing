    ...
    scenarios: [
      {
        ...
        alt: 'A package labeled "Order Online" on a windowsill, representing order and revenue management',
      },
      {
        key: 'multi-entity',
        ...
        alt: 'Someone typing on a laptop at a desk, representing coordinating operations across multiple business entities',
      },
      {
        key: 'controls',
        ...
        alt: 'A phone screen showing a sign-in approval request, representing access controls and permission levels',
      },
      {
        key: 'procurement-erp',
        title: 'Procurement',
        ...
        alt: 'A clipboard checklist next to a laptop, representing procurement requests and approvals',
      },
      {
        key: 'hr-payroll',
        title: 'HR & payroll',
    ...
    scenarios: [
      {
        ...
        image: '/images/logistics-fleet-tracking.jpg',
        alt: 'A row of white delivery vans parked in a lot, representing a tracked delivery fleet',
      },
      {
        key: 'warehouse',
        ...
        image: '/images/logistics-warehouse-management.jpg',
        alt: 'A warehouse worker checking a warehouse management system dashboard on a tablet among stocked shelves',
      },
      {
        key: 'routing',
        ...
        image: '/images/logistics-route-optimization.jpg',
        alt: 'Aerial view of a multi-lane highway interchange with a transit train crossing, representing route planning across a road network',
      },
      {
        key: 'customs',
        ...
        image: '/images/logistics-customs-documentation.jpg',
        alt: 'Stacked shipping containers from multiple carriers at a port, representing cross-border freight and customs handling',
      },
      {
        key: 'carrier-billing',
        ...
        image: '/images/logistics-carrier-billing.jpg',
        alt: 'A freight carrier ship docked at port being loaded with shipping containers',
      },
    ],
  },
  {
    ...
    scenarios: [
      {
        ...
        alt: 'An office team working at desks with a laptop showing a product spreadsheet in the foreground, representing a CRM tracking listings and leads',
      },
      {
        ...
        alt: 'A house-shaped keychain with a key hanging over paperwork showing percentage charts, representing a lease renewal decision',
      },
      {
        key: 'maintenance',
        ...
        alt: 'A home interior mid-renovation with drywall installed and construction materials on the floor, representing a maintenance request in progress',
      },
      {
        key: 'escrow',
        ...
        alt: 'A hand holding house keys with paperwork in the background, representing a completed payment and handover',
      },
      {
        key: 'valuation',
